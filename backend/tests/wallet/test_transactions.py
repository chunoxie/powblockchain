...
def test_valid_transaction():
    Transaction.is_valid_transation(Transaction(Wallet(), 'recipient', 50))
...
def test_valid_transaction_with_invalid_outputs():
    ...
    with pytest.raises(Exception, match='Invalid transaction output values'):
        Transaction.is_valid_transation(transaction)
...
def test_valid_reward_transaction():
    ...
    Transaction.is_valid_transation(reward_transaction)
