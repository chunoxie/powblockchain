...
class Transaction:
    ...
    def create_input(self, sender_wallet, output):
        """
        structurethe input data for the transaction.
    ...
    def from_json(transaction_json):
        """
        Deserialize transaction json represntation back into a Transaction instance
        """
        # return Transaction(
    ...
    @staticmethod
    def is_valid_transation(transaction):
        """
